...
ANGLE_DOOR_LEFT_OPEN = 14       # Calibrated offset angle for fully retracted (open) door
ANGLE_DOOR_LEFT_CLOSED = 142    # Calibrated offset angle for fully extended (closed) door
